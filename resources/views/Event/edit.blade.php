...
<div class="card mb-4" style="padding:5px" >
    <div class="card-body">
    <form action="{{url('/events')}}/{{$event->id}}" method="post" autocomplete="off">
        @method('patch')
        @csrf
        <div class="row mb-3">
            <div class="col-sm-6">
                <label for="date" class="col-form-label" style="font-size:14px">Titulo</label>
                <input type="text"name="title" class="form-control" id="title" style="font-size:12px" value="{{$event->title}}">
            </div>
            <div class="col-sm-6">
                <label for="date" class="col-form-label" style="font-size:14px">Fecha</label>
                <input type="date"name="date" class="form-control" id="date" style="font-size:12px" value="{{$event->date}}">
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-sm-6">
                <label for="time" class="col-form-label" style="font-size:14px">Hora</label>
                <input type="time"name="time" class="form-control" id="time" style="font-size:12px" value="{{$event->time}}">
            </div>
            <div class="col-sm-6" >
                <label for="event_type_id" class="col-form-label" style="font-size:14px">Tipo de eventto</label>
