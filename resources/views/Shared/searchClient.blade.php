 ...
 <input type="text" name="client" data-bd_client="{{isset($bd_client)?true:false}}" class="client form-control" id="client_name" value="{{$client_name ?? $client?->reference}}" style="font-size:12px;">
