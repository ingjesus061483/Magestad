    ...
    <table  class=" table-hover table-bordered" style="width:100%">
        <thead style ="font-size: 14px" >
            <tr>
                ...
                <th style="text-align:center">REFERENCIA DEL PRESTAMO</th>
                ...
                <th style="text-align:center">TIPO DE CREDITO</th>
        ...
        <tbody style ="font-size: 12px">
            @foreach ($clients as $item)
                    <tr>
                        <td>
                            <a href="{{url('/clients/'.$item->id)}}" title="Ver detalles" class="btn btn-info btn-sm">
                                <i class="fa-solid fa-eye"></i>
                            </a>
                        </td>
                        <td>
                            <a data-id="{{ $item->id }}"
                                title="Editar" class="btnEditClient btn btn-warning btn-sm">
