...
<!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/')}}">
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="{{asset('resources/img/magestad.png')}}" width="50px" height="50px">
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{url('/Newness')}}">Novedades</a>
        <a class="collapse-item" href="{{url('/homework')}}"> Tareas</a>
        <a class="collapse-item" href="{{url('/requestLoan')}}">Solicitudes de préstamo</a>
...
@else
   <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Login Screens:</h6>
                        <a class="collapse-item" href="{{url('/clients/create')}}">Solicitud de credito</a>
                    </div>
                </div>
            </li>
